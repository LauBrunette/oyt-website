 ...
 */
final class Version20210720112216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT DEFAULT NULL, ADD tag_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE item ADD category_id INT DEFAULT NULL, ADD tag_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251E12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251EBAD26311 FOREIGN KEY (tag_id) REFERENCES tag (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, DROP tag_id');
        $this->addSql('ALTER TABLE item DROP FOREIGN KEY FK_1F1B251E12469DE2');
        $this->addSql('ALTER TABLE item DROP FOREIGN KEY FK_1F1B251EBAD26311');
        $this->addSql('DROP INDEX IDX_1F1B251E12469DE2 ON item');
        $this->addSql('DROP INDEX IDX_1F1B251EBAD26311 ON item');
        $this->addSql('ALTER TABLE item DROP category_id, DROP tag_id');
    }
}
